...
class Tb_Cont_Receber extends CI_Model {
  public function getContaReceber($ctrId){
    ...
    $this->load->database();
    $this->db->select("ctr_id, ctr_cli_id, ctr_dtvencimento, ctr_valor, ctr_dtpagamento, ctr_valor_pago, ctr_obs, ctr_deletado");
  ...
  private function validaInsert($arrContRecebDados){
    ...
    if( $vCliId == "" ){
      $arrRet["erro"] = true;
      $arrRet["msg"]  = "A Conta a Receber precisa ter um Cliente!";
      return $arrRet;
    }
  ...
  public function getHtmlContasReceber($arrFilters=array(), $edit=true, $totais=true){
    ...
    $vSql  = " SELECT ctr_id, cli_nome, ctr_dtvencimento, ctr_valor, ctr_dtpagamento, ctr_valor_pago ";
